...
class CuentaResponse(BaseModel):
    ...
    Numero: Optional[str] = Field(None, min_length=1, max_length=20, description="Número de cuenta único")
    FechaApertura: Optional[date] = Field(None, description="Fecha de apertura de la cuenta")
    IdTipoCuenta: Optional[int] = Field(None, gt=0, description="ID del tipo de cuenta")
    IdSucursal: Optional[int] = Field(None, gt=0, description="ID de la sucursal")
    Saldo: Optional[Decimal] = Field(default=Decimal("0.00"), ge=0, description="Saldo actual de la cuenta")
    Sobregiro: Optional[Decimal] = Field(default=Decimal("0.00"), ge=0, description="Límite de sobregiro")
    GranMovimiento: Optional[bool] = Field(default=False, description="Indica si tiene gran movimiento")
    SobregiroNoAutorizado: Optional[bool] = Field(default=False, description="Indica sobregiro no autorizado")
